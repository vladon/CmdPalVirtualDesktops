...
- **Command IDs are reverse-DNS + position index**: `com.vladon.virtualDesktops`, `com.vladon.virtualDesktops.switchTo.{index}`, `com.vladon.virtualDesktops.moveWindow.{index}`. Keep that scheme for new commands.
