...
- **Command IDs are reverse-DNS + position index**: `com.zadjii.virtualDesktops`, `com.zadjii.virtualDesktops.switchTo.{index}`, `com.zadjii.virtualDesktops.moveWindow.{index}`. Keep that scheme for new commands.
